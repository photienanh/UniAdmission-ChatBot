...
async def ask_llm(
    ...
    if model_id == GEMINI_MODEL or model_id == "undefined":
        ...
        intermediate = await SLM.ask(model_id, question, session_id, web_search_params={"in_domain": False, "k_docs": 3, "k_pages": 3})
        result = {
