<<<<<<< HEAD:app/static/index.js
=======
import { stream_text } from "/static/stream.js";

>>>>>>> 36adcd4a3b9a4de7c67ba0935221121c9e22a799:app/frontend/static/index.js
...
<<<<<<< HEAD:app/static/index.js
        ...
        if (useWebSearch) { 
            ...
            webSearchParam = {
                in_domain: priorityDomains.checked,
                k_pages: parseInt(searchResultsCount.value),
                k_docs: kDocsValue
            }
        }
        // Send to backend
...
<<<<<<< HEAD:app/static/index.js
        ...
        .then(data => {
            ...
            if (data.error) {
                ...
                console.log('Search sources:', data.search_sources); // Debug log
                addMessage(data.message, 'bot', data.search_sources || null);
...
<<<<<<< HEAD:app/static/index.js
                ...
                addMessage(message.message, message.role, sources);
=======
